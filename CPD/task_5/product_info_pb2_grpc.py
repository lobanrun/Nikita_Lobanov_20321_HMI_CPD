...
class ProductInfoStub(object):
    """Missing associated documentation comment in wrappers.proto file."""
...
class ProductInfo(object):
    ...
    def deleteProduct(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ecommerce.ProductInfo/deleteProduct',
            product__info__pb2.ProductID.SerializeToString,
